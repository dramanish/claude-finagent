...
- **Paste this repo URL** — `https://github.com/Fifty-Years/anthropic-financial-services` — then pick the agents and verticals you want from the marketplace list, or
